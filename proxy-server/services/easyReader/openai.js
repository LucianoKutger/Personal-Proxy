      ...
      messages: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              text: "Übersetze folgenden HTML tag in einfache Sprache nach der DIN 8581-1 und DIN ISO 24495-1, Halte dich an folgende Vorgaben: " + SYSTEM_INSTRUCTIONS + "achte darauf das alle Vorgaben, eingehalten wurden wie z.B. die Länge des Satzes etc. prüfe vor der Finalen übergabe der Übersetzung akribisch ob alle Vorgaben erfüllt wurden und ändere gegebenenfalls noch etwas ab sodass diese eingehalten werden. Achte darauf das du mir ausschließlich den Tag gibst mit Überstezten Inhalt. Behalte die Sprache also wenn der übergebene inhalt des HTML Tags Deutsch ist dann übersrtze auf deutsch wenn er auf Englisch ist dann auf Englisch etc., behalte alle Inline tags bei, keine Kommentare, keine zusatz bemerkungen, einfach den überstezten HTML tag in den Chat hier der zu übersetzende Tag: " + paragraph,
            },
          ],
        },
      ],
